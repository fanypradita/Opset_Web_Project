        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <h2>Konsultasi</h2>
              <p>Layanan jasa konsultasi advisory yang tersedia di PerhutaniPro dapat anda pilih dan sesuaikan dengan kebutuhan anda.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row g-5">
          ...
          <div style="width:60%" class="col-lg-8">
            ...
            <article class="blog-details">
              ...
              <div class="post-img">
                <img src="assets/img/blog/konsul1.jpg" alt="" class="img-fluid">
              </div>

              <h2 class="title">Konsultasi bersama Perhutani</h2>
              ...
              <div class="content">
                <div class="card mb-4">
                  <div class="row g-0">
                    <div class="col-lg-4">
                      <img src="https://aesia.kemenkeu.go.id/api/v1/user_files/uploads/konsultasi-jenis-layanan-1.jpg" alt="..." class="img-fluid rounded-start"></div> 
                      <div class="col-lg-8">
                        <div class="card-body">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card mb-4">
                      <div class="row g-0">
                        <div class="col-lg-4">
                          <img src="https://aesia.kemenkeu.go.id/api/v1/user_files/uploads/konsultasi-jenis-layanan-3.jpg" alt="..." class="img-fluid rounded-start"></div> 
                          <div class="col-lg-8">
                            <div class="card-body">
