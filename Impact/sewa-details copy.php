                ...
                <form method="POST">
                  ...
                  <div class="row">
                    <div class="col-md-6 form-group">
                      ...
                      <input name="no_telepon" type="number" class="form-control" placeholder="No.telepon*">
                    </div>
                    <br>
                    <div class="col-md-6 form-group">
                  ...
                  <div class="row">
                    <br>
                      ...
                      <input style="margin-left:12px;" type="date" name="tanggal" id="date1" class="form-control mr-2" mar>
                    </div>
                    <br>
                    <div class="row">
