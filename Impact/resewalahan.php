        ...
        <?php
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            if ($row["kategori_aset"] == "tanah") {
              ...
              echo '<a href="resub-sewa1lahan.php?id_aset=' . $row["id_aset"] . '"><img src="' . $row["images"] . '" alt="" class="img-fluid"></a>';
              echo '</div>';
              echo '<h2 class="title">';
              echo '<a href="resub-sewa1lahan.php?id_aset=' . $row["id_aset"] . '">' . $row["nama_aset"] . '</a>';
