...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($select) > 0){
      ...
      if($password != $cpass){
         ...
         $insert = mysqli_query($conn, "INSERT INTO tbl_admin(nama, alamat, jk, npk, email, password, images) VALUES('$nama', '$alamat', '$jk', '$npk' '$email', '$password', '$images')") or die('query failed');
...
<div class="form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      ?>
      <input type="text" name="npk" placeholder="enter npk" class="box" required>
