        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <h2>Kotak Pengajuan</h2>
              <p>Pemohon dapat melakukan pengajuan sewa ataupun kerjasama pada form di bawah ini.
                Untuk proses pengajuan akan diproses 1 sampai 3 hari.
              </p>
            </div>
          </div>
        </div>
