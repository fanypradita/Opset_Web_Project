...
echo '<a href="resub-sewa1.php?id=' . $row["id"] . '&nama_aset=' . $row["nama_aset"] . '"><img src="' . $row["images"] . '" alt="" class="img-fluid"></a>';
echo '</div>';
echo '<h2 class="title">';
echo '<a href="resub-sewa1.php?id=' . $row["id"] . '&nama_aset=' . $row["nama_aset"] . '">' . $row["sub_kategori1"] . '</a><br>';
