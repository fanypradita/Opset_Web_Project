      ...
      <div class="container" data-aos="fade-up">
        ...
        <?php
          ...
          if (isset($_GET["search"])) {
            ...
            $sql = "SELECT nama_aset, kategori_aset, sub_kategori1, alamat, images, id, id_aset, COUNT(nama_aset) AS jumlah
            FROM opset 
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<a href="resub-sewasport.php?id_aset=' . $row["id_aset"] . '"><img src="' . $row["images"] . '" alt="" class="img-fluid"></a>';
            echo '</div>';
            echo '<h2 class="title">';
            echo '<a href="resub-sewasport.php?id_aset=' . $row["id_aset"] . '">' . $row["sub_kategori1"] . '</a>';
            echo '<p class="post-category">' . $row["alamat"] . '</p>';
            echo '<p class="post-category">' . $row["kategori_aset"] . '</p>';
            echo '</h2>';
            echo '</article>';
