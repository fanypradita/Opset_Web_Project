        ...
        <ul>
          ...
          <li class="dropdown"><a href="sewa.php"><span>Sewa Aset</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              ...
              <li class="dropdown"><a href="#"><span>Tanah</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                <ul>
                  <li><a href="#">Tanah Kavling</a></li>
                  <li><a href="#">Tanah Sawah</a></li>
                  <li><a href="#">Tanah Liat</a></li>
                  <li><a href="#">Tanah Industri</a></li>
                </ul>
              </li>
            </ul>
          </li>
