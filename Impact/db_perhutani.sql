...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Feb 2023 pada 07.19
...
--
CREATE DATABASE IF NOT EXISTS `db_perhutani` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `db_perhutani`;
...
INSERT INTO `tbl_admin` (`id`, `nama`, `alamat`, `jk`, `email`, `password`, `images`) VALUES
...
('root', '[{\"db\":\"coba\",\"table\":\"tbl_admin\"},{\"db\":\"db_perhutani\",\"table\":\"tbl_admin\"},{\"db\":\"db_perhutani\",\"table\":\"tbl_aset\"},{\"db\":\"db_perhutani\",\"table\":\"tbl_customer\"}]');
...
('root', '2023-02-16 06:18:58', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"id\",\"NavigationWidth\":242}');
