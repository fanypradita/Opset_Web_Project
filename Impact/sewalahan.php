          ...
          if (!$conn) {
            die("Connection failed: " . mysqli_connect_error());
                  ...
                  while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<a href="sub-sewa1lahan.php?id_aset=' . $row["id_aset"] . '"><img src="' . $row["images"] . '" alt="" class="img-fluid"></a>';
                    echo '</div>';
                    echo '<h2 class="title">';
                    echo '<a href="sub-sewa1lahan.php?id_aset=' . $row["id_aset"] . '">' . $row["sub_kategori2"] . '</a>';
                    echo '<p class="post-category">' . $row["alamat"] . '</p>';
                    echo '<p class="post-category">' . $row["kategori_aset"] . '</p>';
                    echo '</h2>';
                    echo '</article>';
