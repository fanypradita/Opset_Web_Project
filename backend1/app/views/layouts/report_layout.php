...
<body>
		...
		<table class="table table-sm">
			<tr>
				...
				<th align="left" valign="middle">
					...
					<small class="sub-title">Devisi Regional Jawa Tengah</small>
				</th>
				<th align="right" valign="middle">
					<div class="company-info">
						<div>Phone: <span class="sub-title">(024) 8413631</span></div>
						<div>Email: <span class="sub-title">divrejateng@perhutani.co.id</span></div>
						<div>Web: <span class="sub-title">www.perhutani.co.id</span></div>
					</div>
	...
	<p text align="center">Dinas Perhutani</p>
	<div id="report-body">
		<?php
		$this->render_body();
		?>
