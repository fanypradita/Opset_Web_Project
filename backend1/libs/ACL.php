	...
	public static $role_pages = array(
			'super admin' =>
						array(
							...
							'opset' => array('list','view','add','edit', 'editfield','delete'),
							'pengajuan' => array('list','view','edit', 'editfield','delete','list','view','add','edit', 'editfield','delete','proses','terima','tolak')
						),
		
			'user' =>
						array(
							'opset' => array('list','view','add','edit', 'editfield','delete'),
							'pengajuan' => array('list','view','list','view','proses','terima','tolak')
						),
		
			'admin' =>
						array(
							'user' => array('list','view','add','import_data'),
							'opset' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'pengajuan' => array('list','view','edit', 'editfield','proses','terima','tolak','import_data')
						)
		);
