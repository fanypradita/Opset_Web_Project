<?php 
/**
 * Pengajuan Page Controller
 * @category  Controller
 */
class PengajuanController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$this->render_view("pengajuan/list.php", $data); //render the full page
	}
	/**
     * View record detail 
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("pengajuan.id_pengajuan", $rec_id);; //select record based on primary key
		}
		$record = $db->getOne($tablename, $fields );
		if($record){
			$page_title = $this->view->page_title = "View  Pengajuan";
		$this->view->report_filename = date('Y-m-d') . '-' . $page_title;
		$this->view->report_title = $page_title;
		$this->view->report_layout = "report_layout.php";
		$this->view->report_paper_size = "A4";
		...
		return $this->render_view("pengajuan/view.php", $record);
	}
	/**
	...
	function add($formdata = null){
		...
		$page_title = $this->view->page_title = "Add New Pengajuan";
		$this->render_view("pengajuan/add.php");
	}
	/**
	...
	function edit($rec_id = null, $formdata = null){
		...
		if($formdata){
			...
			$modeldata = $this->modeldata = $this->validate_form($postdata);
			if($this->validated()){
				$db->where("pengajuan.id_pengajuan", $rec_id);;
		...
		return $this->render_view("pengajuan/edit.php", $data);
	}
	/**
     * Update single field
	 * @param $rec_id (select record by table primary key)
	...
	function delete($rec_id = null){
		...
		$db->where("pengajuan.id_pengajuan", $arr_rec_id, "in");
	...
	function proses($fieldname = null , $fieldvalue = null){
		...
		$this->view->report_paper_size = "A4";
		$this->view->report_orientation = "portrait";
		$this->render_view("pengajuan/proses.php", $data); //render the full page
	}
	/**
     * List page records
     * @param $fieldname (filter record by a field) 
     ...
     * @return BaseView
     */
	function terima($fieldname = null , $fieldvalue = null){
		$request = $this->request;
		$db = $this->GetModel();
		$tablename = $this->tablename;
		$fields = array("id_pengajuan", 
		...
		$this->view->report_paper_size = "A4";
		$this->view->report_orientation = "portrait";
		$this->render_view("pengajuan/terima.php", $data); //render the full page
	}
	/**
     * List page records
     * @param $fieldname (filter record by a field) 
     ...
     * @return BaseView
     */
	function tolak($fieldname = null , $fieldvalue = null){
		$request = $this->request;
		$db = $this->GetModel();
		$tablename = $this->tablename;
		$fields = array("id_pengajuan", 
