        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="col-md-3 col-sm-4 comp-grid">
                    ...
                    <a class="animated zoomIn record-count card bg-light text-dark"  href="<?php print_link("tbl_opset/") ?>">
                        <div class="row">
                            <div class="col-2">
                ...
                <div class="col-md-3 col-sm-4 comp-grid">
                    ...
                    <a class="animated zoomIn record-count card bg-light text-dark"  href="<?php print_link("pengajuan/") ?>">
                        <div class="row">
                            <div class="col-2">
