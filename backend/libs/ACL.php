...
class ACL
{
	...
	public static $role_pages = array(
			'administrator' =>
						array(
							'pengajuan' => array('list','view','edit', 'editfield','proses','terima','tolak'),
							'tbl_opset' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'user' => array('list','view','add','userregister')
						),
		
			'user' =>
						array(
							'pengajuan' => array('list','view','proses','terima','tolak'),
							'tbl_opset' => array('list','view','add','edit', 'editfield','delete','import_data'),
			...
			'super admin' =>
						array(
							'pengajuan' => array('list','view','add','edit', 'editfield','delete','proses','terima','tolak','import_data'),
							'tbl_opset' => array('list','view','add','edit', 'editfield','delete','import_data'),
